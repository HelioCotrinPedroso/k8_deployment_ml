...
# Carregar o modelo
modelo_dsa = joblib.load("modelo.pkl")

# Configuração da página do Streamlit
st.set_page_config(page_title="Hélio Pedroso", page_icon=":100:", layout="wide")
...
if st.sidebar.button("Suporte"):
    st.sidebar.write("No caso de dúvidas envie e-mail para: Hélio")

# Título centralizado
st.title("Hélio Pedroso")
